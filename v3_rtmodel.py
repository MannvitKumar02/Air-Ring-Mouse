...
LOCK_DURATION_MS = 800            # 🔥 Increased from 400ms → 800ms: longer freeze after idle
                                   #    gives hand time to fully settle before jerk is re-armed

TAP_JERK_TRIGGER = 1500.0          
ML_CAPTURE_WINDOW_MS = 600         

# 🔥 NEW: After idle lock expires, ignore jerk triggers for this many ms
#    This is the "post-idle cooldown" — prevents residual settling vibration
#    from firing a spurious click right after the hand stops moving
POST_IDLE_COOLDOWN_MS = 600        
...
# 🔥 NEW: Post-idle cooldown — jerk trigger is blocked until this timestamp
#    Set whenever an idle lock expires, to prevent settling-vibration false clicks
post_idle_cooldown_until = 0.0
